...
\restrict 9Bf8ixRYuCfwwX5UJOT6V6PbzhTLSGTHubiUCXnBIbcUV1LAk8l3wjk87iR1OcE
...
INSERT INTO public.scorecards (id, name, slug, title, data_source, published, linked_indicator, rank, created_at, updated_at, scope) VALUES (1, 'Households/AverageHouseholdSize', 'households.average-household-size', '{"en": "Average household size"}', 'households', true, 'households.average-household-size', NULL, '2024-09-10 11:24:09', '2026-02-17 12:19:19', 'Everywhere') ON CONFLICT DO NOTHING;
INSERT INTO public.scorecards (id, name, slug, title, data_source, published, linked_indicator, rank, created_at, updated_at, scope) VALUES (2, 'Households/AverageInterviewTime', 'households.average-interview-time', '{"en": "Average interview time"}', 'households', true, NULL, NULL, '2024-09-10 11:30:49', '2026-02-17 12:19:28', 'Everywhere') ON CONFLICT DO NOTHING;
INSERT INTO public.scorecards (id, name, slug, title, data_source, published, linked_indicator, rank, created_at, updated_at, scope) VALUES (4, 'Households/DeathRate', 'households.death-rate', '{"en": "Death rate"}', 'households', true, NULL, NULL, '2024-09-10 11:31:31', '2026-02-17 12:19:38', 'Everywhere') ON CONFLICT DO NOTHING;
INSERT INTO public.scorecards (id, name, slug, title, data_source, published, linked_indicator, rank, created_at, updated_at, scope) VALUES (7, 'Households/TotalHouseholds', 'households.total-households', '{"en": "Total households"}', 'households', true, NULL, NULL, '2024-09-10 11:32:51', '2026-02-17 12:19:44', 'Everywhere') ON CONFLICT DO NOTHING;
...
\unrestrict 9Bf8ixRYuCfwwX5UJOT6V6PbzhTLSGTHubiUCXnBIbcUV1LAk8l3wjk87iR1OcE
