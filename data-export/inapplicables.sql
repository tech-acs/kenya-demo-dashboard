...
--
-- Data for Name: inapplicables; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- Name: inapplicables_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.inapplicables_id_seq', 1, false);
